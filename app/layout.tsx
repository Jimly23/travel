...
export const metadata: Metadata = {
  ...
  title: {
    default: "DAFFA TRAVEL | Travel Brebes - Jakarta PP | Carter & Antar Jemput",
    template: "%s | DAFFA TRAVEL",
  },

  description:
    "DAFFA TRAVEL merupakan jasa travel Brebes terpercaya melayani rute Brebes - Jakarta PP, antar jemput bandara, carter mobil, dan pengiriman paket dengan armada nyaman serta driver profesional.",
  ...
  creator: "DAFFA TRAVEL",

  publisher: "DAFFA TRAVEL",
  ...
  openGraph: {
    ...
    siteName: "DAFFA TRAVEL",
    title: "DAFFA TRAVEL | Travel Brebes Terpercaya",
    description:
